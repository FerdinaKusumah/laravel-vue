...
if(isset($_POST["submit"])) {
    ...
    if(tambah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'tambah_katalog.php';
        </script>
    ";
    }
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Katalog</h1>
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="id_katalog">Id Katalog</label>
                                    <input type="text" class="form-control" name="id_katalog" placeholder="Id Katalog">
                                </div>
                                <div class="form-group">
