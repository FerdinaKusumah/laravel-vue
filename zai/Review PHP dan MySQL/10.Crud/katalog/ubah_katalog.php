...
$katalog = query("SELECT * FROM katalog WHERE id_katalog = '$id_katalog'")[0];
...
if(isset($_POST["submit"])) {
    ...
    if(ubah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'ubah_katalog.php';
        </script>
    ";
    }
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Katalog</h1>
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="id_katalog">Id Katalog</label>
                                    <input type="text" readonly class="form-control" name="id_katalog"
                                        placeholder="Id Katalog" value="<?= $katalog["id_katalog"];?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama_katalog">Nama Katalog</label>
                                    <input type="text" class="form-control" name="nama" placeholder="Nama Katalog"
                                        value="<?= $katalog["nama"];?>">
                                </div>
