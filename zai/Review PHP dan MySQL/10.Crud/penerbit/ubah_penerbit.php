...
if(isset($_POST["submit"])) {
    ...
    if(ubah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'ubah_penerbit.php';
        </script>
    ";
    }
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Penerbit</h1>
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="id_penerbit">Id Penerbit</label>
                                    <input type="text" readonly class="form-control" name="id_penerbit"
                                        placeholder="Id Penerbit" value="<?= $penerbit["id_penerbit"];?>">
                                </div>
                                <div class="form-group">
