...
// Query data penerbit berdasarkan penerbit
$pengarang = query("SELECT * FROM pengarang WHERE id_pengarang = '$id_pengarang'")[0];
...
if(isset($_POST["submit"])) {
    ...
    if(ubah($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'ubah_pengarang.php';
        </script>
    ";
    }
}
...
<head>
    ...
    <title>Ubah Data Pengarang</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Pengarang</h1>
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="id_pengarang">Id Pengarang</label>
                                    <input type="text" readonly class="form-control" name="id_pengarang"
                                        placeholder="Id Pengarang" value="<?= $pengarang["id_pengarang"];?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama_pengarang">Nama Pengarang</label>
                                    <input type="text" class="form-control" name="nama_pengarang"
                                        placeholder="Nama Pengarang" value="<?= $pengarang["nama_pengarang"];?>">
                                </div>
                                <div class="form-group">
