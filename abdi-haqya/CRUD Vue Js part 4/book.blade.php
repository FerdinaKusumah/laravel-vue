	...
	<div class="row">
		<div class="col-md-5 offset-md-3">
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" autocomplete="off" placeholder="Search for title" v-model="search">
			</div>
		</div>
				...
				<form method="post" action="" autocomplete="off">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<select type="publisher_id" class="form-control">
						...
						<div class="form-group">
							<label>Author</label>
							<select type="author_id" class="form-control">
						...
						<div class="form-group">
							<label>Catalog</label>
							<select type="catalog_id" class="form-control">
		...
		methods: {
			...
			deleteData(id) {
				...
				if (confirm("Are you sure?")) {
					axios.post(this.book, {_method: 'DELETE'}).then(response => {location.reload();
					})
				}
			},
			numberWithSpaces(x) {
